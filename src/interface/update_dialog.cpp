...
int CUpdateDialog::ShowModal()
{
...

	{
		...
		s->Add(new wxHyperlinkCtrl(p, XRCID("ID_WEBSITE_LINK"), L"https://hasanparasteh.ir/", L"https://hasanparasteh.ir/"));
...

	{
		...
		s->Add(new wxHyperlinkCtrl(p, XRCID("ID_NEWVERSION_WEBSITE_LINK"), L"https://hasanparasteh.ir/", L"https://hasanparasteh.ir/"));
	}
